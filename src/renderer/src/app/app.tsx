...
import { ExperimentProgressPanel } from '@renderer/features/experiment/experiment-progress-panel'
import { isExperimentSessionOpen } from '@renderer/features/experiment/experiment-progress'
...
export default function App() {
  ...
  const pendingNewSessionPlaceholder = useUIStore((s) => s.pendingNewSessionPlaceholder)
  const timelineItemCount = useUIStore((s) => s.timelineItems.length)
  const historyLoading = useUIStore((s) => s.historyLoading)
  const showExperimentProgress = isExperimentSessionOpen({
    currentSessionId,
    historySessionFile,
        ...
        <MainLayoutShell
          ...
          center={
            <MainColumnWithTimelineScroll className="h-full">
              ...
              {showExperimentProgress && <MainColRightPanelToggle />}
          ...
          right={
            <RightPanel>
              {showExperimentProgress && !rightPanelCollapsed ? <ExperimentProgressPanel /> : null}
            </RightPanel>
          }
          rightVisible={showExperimentProgress}
        />
      </div>
      <AppToaster />
      <ExtensionUIHost />
