...
import { McpServersPanel } from '@renderer/features/settings/mcp-servers-panel'
...
export function ExtensionsSettings() {
  ...
  return (
    <div className="space-y-1 w-full">
      ...
      <McpServersPanel />
      <div className="mt-6 border-t border-border/50 pt-5 text-[14px] font-semibold">
        {t('settings:extensions.piExtensions')}
      </div>
      {extensions.length === 0 ? (
